...
import 'package:flutter_application_1/Views/screens/checkout_screen.dart';
import 'package:flutter_application_1/Views/screens/popup_screens/product_details_screen.dart';
  ...
  double _calculateTotalPrice(List<QueryDocumentSnapshot> cartItems) {
    ...
    for (var doc in cartItems) {
      ...
      double discountedPrice =
          cartItem.productPrice - (cartItem.productPrice * (cartItem.discount / 100));
